class Agent:
    ...
    def _run_stream_ndjson(self, content: str, task: str, **params): raise NotImplementedError("This is an abstract agent class")
    ...
    def simplificationStream_ndjson(self, content: str, **params): return self._run_stream_ndjson(content, task="simplification", **params)
