    ...
    def __init__(self, connector=None):
        object.__setattr__(self, "data", DotDict(
            ...
            use=DotDict(
                ...
                factors=LongText("Foreseeable salient factors for which model performance may vary.", is_refinable=True),
            ...
            training=DotDict(
                ...
                motivation=LongText("Why were training datasets chosen?", is_refinable=True),
            ...
            performance=DotDict(
                ...
                energy_consumption=LongText("Report of energy consumption or energy consumption rate.", technical_nature=True),
