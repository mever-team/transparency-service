...
transparency_service.utils.get_data(rf"{base}/tweepfake/validation.csv", delimiter=";")
transparency_service.utils.get_data(
...
transparency_service.utils.get_data(rf"{base}/gpt-2-output-dataset")
