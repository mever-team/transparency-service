...
from transparency.service.assistant import TestAssistant
import json
import time

app = serve({"tassist": TestAssistant(delay=0.1)})  # delay is the number of seconds in which no more updates are available
...
def test_submit():
    ...
    full_card = {
      ...
      "training_set": {
        "description": "This may be formatted as html. Example: <h1>Data gathering</h1>Data were gathered somehow, swometime, somewhere.<h1>Concerns</h1>There was no quality check.",
        "plot": "This may be formatted as html. For now, this may have some embedded style tags - we can discuss common tags so that all plots look the same. \n                                  <style>\n                                  .barchart {\n                                    display: flex;\n                                    align-items: flex-end;\n                                    gap: 10px;\n                                    height: 150px;\n                                    width: 300px;\n                                    border-left: 2px solid #333;\n                                    border-bottom: 2px solid #333;\n                                    padding: 10px;\n                                    font-family: sans-serif;\n                                  }\n                                  .bar {\n                                    width: 30px;\n                                    background-color: steelblue;\n                                    text-align: center;\n                                    color: white;\n                                    display: flex;\n                                    justify-content: center;\n                                    align-items: flex-end;\n                                  }\n                                  .bar span {\n                                    writing-mode: vertical-rl;\n                                    transform: rotate(180deg);\n                                    margin-bottom: 5px;\n                                  }\n                                </style>\n                                <h3>Bar Chart (Embedded CSS)</h3>\n                                <div class=\"barchart\">\n                                  <div class=\"bar\" style=\"height: 60px;\"><span>3</span></div>\n                                  <div class=\"bar\" style=\"height: 90px;\"><span>5</span></div>\n                                  <div class=\"bar\" style=\"height: 120px;\"><span>7</span></div>\n                                  <div class=\"bar\" style=\"height: 30px;\"><span>1.5</span></div>\n                                </div>\n                               "
      },
      "eval_set": {
        "description": "This may be formatted as html. Example: <h1>Data gathering</h1>Data were gathered somehow, swometime, somewhere.<h1>Concerns</h1>There was no quality check.",
        "plot": "This may be formatted as html. For now, this may have some embedded style tags - we can discuss common tags so that all plots look the same. \n                                  <style>\n                                  .barchart {\n                                    display: flex;\n                                    align-items: flex-end;\n                                    gap: 10px;\n                                    height: 150px;\n                                    width: 300px;\n                                    border-left: 2px solid #333;\n                                    border-bottom: 2px solid #333;\n                                    padding: 10px;\n                                    font-family: sans-serif;\n                                  }\n                                  .bar {\n                                    width: 30px;\n                                    background-color: steelblue;\n                                    text-align: center;\n                                    color: white;\n                                    display: flex;\n                                    justify-content: center;\n                                    align-items: flex-end;\n                                  }\n                                  .bar span {\n                                    writing-mode: vertical-rl;\n                                    transform: rotate(180deg);\n                                    margin-bottom: 5px;\n                                  }\n                                </style>\n                                <h3>Bar Chart (Embedded CSS)</h3>\n                                <div class=\"barchart\">\n                                  <div class=\"bar\" style=\"height: 60px;\"><span>3</span></div>\n                                  <div class=\"bar\" style=\"height: 90px;\"><span>5</span></div>\n                                  <div class=\"bar\" style=\"height: 120px;\"><span>7</span></div>\n                                  <div class=\"bar\" style=\"height: 30px;\"><span>1.5</span></div>\n                                </div>\n                               "
      ...
      "analysis": {
        "description": "This may be formatted as html. Example: This is a short analysis that takes into account the following measures:<ul><li><b>tpr</b> - true positive rates of predicted labels</li><li><b>tnr</b> - true negative rates of predicted labels</li></ul>",
        "plot": "This may be formatted as html. For now, this may have some embedded style tags - we can discuss common tags so that all plots look the same. \n                                  <style>\n                                  .barchart {\n                                    display: flex;\n                                    align-items: flex-end;\n                                    gap: 10px;\n                                    height: 150px;\n                                    width: 300px;\n                                    border-left: 2px solid #333;\n                                    border-bottom: 2px solid #333;\n                                    padding: 10px;\n                                    font-family: sans-serif;\n                                  }\n                                  .bar {\n                                    width: 30px;\n                                    background-color: steelblue;\n                                    text-align: center;\n                                    color: white;\n                                    display: flex;\n                                    justify-content: center;\n                                    align-items: flex-end;\n                                  }\n                                  .bar span {\n                                    writing-mode: vertical-rl;\n                                    transform: rotate(180deg);\n                                    margin-bottom: 5px;\n                                  }\n                                </style>\n                                <h3>Bar Chart (Embedded CSS)</h3>\n                                <div class=\"barchart\">\n                                  <div class=\"bar\" style=\"height: 60px;\"><span>3</span></div>\n                                  <div class=\"bar\" style=\"height: 90px;\"><span>5</span></div>\n                                  <div class=\"bar\" style=\"height: 120px;\"><span>7</span></div>\n                                  <div class=\"bar\" style=\"height: 30px;\"><span>1.5</span></div>\n                                </div>\n                               "
      }
    }
