...
You can use this both with the [🧨Diffusers library](https://github.com/huggingface/diffusers) and [RunwayML GitHub repository](https://github.com/runwayml/stable-diffusion) (now deprecated), ComfyUI, Automatic1111, SD.Next, InvokeAI.
...
2. Follow instructions [here](https://github.com/runwayml/stable-diffusion). (now deprecated)
