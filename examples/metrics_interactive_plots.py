...
mc.fill_bar_plot(plot_title="ACC data", labels=mc.data['label'].tolist(), values=mc.data['acc'].tolist())
mc.fill_bar_plot(plot_title="AP data", labels=mc.data['label'].tolist(), values=mc.data['ap'].tolist())


# add the plots to the json strucure
mc.add_interactive_plot_to(title = "ACC data", destination = "Eval Set")
mc.add_interactive_plot_to(title = "AP data", destination = "Eval Set")
