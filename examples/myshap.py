...
#def _force_plot_html(**kwargs):
#    plt.ioff()
#    shap.image_plot(**kwargs)
#    fig = plt.gcf()
#    shap_html = mtplot_to_base64(fig)
#    plt.ion()
#    return shap_html
...
#mc.json["Quantitative Analysis"]["SHAP Plot"] = _force_plot_html(
...
mc.add_interactive_plot_to(title="SHAP Plot", destination="Eval Set",
